...
public class TrigFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        sinButton.setOnClickListener(v -> setSelectedTrig("sin", sinButton));
        cosButton.setOnClickListener(v -> setSelectedTrig("cos", cosButton));
        tanButton.setOnClickListener(v -> setSelectedTrig("tan", tanButton));
        secButton.setOnClickListener(v -> setSelectedTrig("sec", secButton));
        cosecButton.setOnClickListener(v -> setSelectedTrig("cosec", cosecButton));
        cotButton.setOnClickListener(v -> setSelectedTrig("cot", cotButton));
